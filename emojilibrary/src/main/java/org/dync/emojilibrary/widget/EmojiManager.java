package org.dync.emojilibrary.widget;
...
public class EmojiManager {
  ...
  /**
   * Returns all the {@link org.dync.emojilibrary.widget.Emoji}s for a given tag.
   *
   * @param tag the tag
   *
   * @return the associated {@link org.dync.emojilibrary.widget.Emoji}s, null if the tag
   * is unknown
   */
  ...
  /**
   * Returns the {@link org.dync.emojilibrary.widget.Emoji} for a given alias.
   *
   * @param alias the alias
   *
   * @return the associated {@link org.dync.emojilibrary.widget.Emoji}, null if the alias
   * is unknown
   */
  ...
  /**
   * Returns the {@link org.dync.emojilibrary.widget.Emoji} for a given unicode.
   *
   * @param unicode the the unicode
   *
   * @return the associated {@link org.dync.emojilibrary.widget.Emoji}, null if the
   * unicode is unknown
   */
  ...
  /**
   * Returns all the {@link org.dync.emojilibrary.widget.Emoji}s
   *
   * @return all the {@link org.dync.emojilibrary.widget.Emoji}s
   */
