...
*The missing emoji library for android.*

**emojiLibrary** is a lightweight android library that helps you use Emojis in your app.
...
**emojiLibrary ** originally used the data provided by the [github/gemoji project](https://github.com/github/gemoji). It is still based on it but has evolved since.
